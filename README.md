...
- Сезонность
  - летом больше всего путешественников (x2 трафика)
- Временные ограничения
  - время оценки поста не должно превышать 300 мс
  - время загрузки ленты не должно превышать 2 секунды
  - время загрузки фотографий в посте не должно превышать 1 секунду
  - время публикации поста не должно превышать 1 секунду
